<script context="module" lang="ts">
  ...
  import ThreadMessage from '../../components/ThreadMessage.svelte';
...
<script lang="ts">
  ...
  import SubmitRow from '../../components/SubmitRow.svelte';
  import ComposeRow from '../../components/ComposeRow.svelte';
